...
public class MapPage extends BaseTest {
	...
	By canvas = By.cssSelector(".widget-scene-canvas");
	By popupMenu = By.xpath("//div[@class='action-menu-entry-text']");

	
	public void searchPlace(String place) {
		String xpathSearch = "//div[@id='suggestions-grid']//span[text()='" + place +"']";
		WebElement element = driver.findElement(By.xpath(xpathSearch));
		element.click();
		sleep(5000);
	}
